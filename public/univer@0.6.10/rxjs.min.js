...
(function (g, y) {
  ...
  function ae(b, a, c) {
    ...
    function e(a, c) {
      try {
        var b = k[a](c);
        b.value instanceof ca ? Promise.resolve(b.value.v).then(f, h) : l(p[0][2], b);
      } catch (u) {
        l(p[0][3], u);
      }
    }
      ...
      return Ua(this, function (f) {
        switch (f.label) {
          ...
          case 2:
            return [4, ca(a.read())];
          case 3:
            return (c = f.sent()), (d = c.value), (e = c.done) ? [4, ca(void 0)] : [3, 5];
          case 4:
            return [2, f.sent()];
          case 5:
            return [4, ca(d)];
    ...
    return $d(this, void 0, void 0, function () {
      ...
      return Ua(this, function (k) {
        switch (k.label) {
          ...
          case 6:
            return (
              k.trys.push([6, , 9, 10]), d && !d.done && (f = c.return) ? [4, f.call(c)] : [3, 8]
            );
          case 7:
            k.sent(), (k.label = 8);
          case 8:
    ...
    return n(function (a, c) {
      ...
      a.subscribe(
        m(
          ...
          function () {
            d ? (c.next(e), c.complete()) : c.error(f ? new ld('No matching values') : new aa());
          },
        ),
      );
    });
  ...
  var bf = (function (b) {
    ...
    df = Object.freeze({ ajax: ba, AjaxError: wa, AjaxTimeoutError: Md, AjaxResponse: yb }),
    ef = {
      url: '',
